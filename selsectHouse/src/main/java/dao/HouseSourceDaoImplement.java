	...
	public List<HouseSource> selectInfoAll() {
		...
		try {
			...
			while(resultSet.next()) {
			      ...
			      houseSource.setISPASS(resultSet.getString(15));
...
//	
	...
	@Override
	public boolean verifyInfo(String ESTATE_ID, String LOTTERY_START_TIME, String LOTTERY_END_TIME,String SELECT_HOUSE_START_TIME, String SELECT_HOUSE_END_TIME) {
		...
		try {
			...
			statement.setString(4, SELECT_HOUSE_START_TIME);
			statement.setString(5, SELECT_HOUSE_END_TIME);
	...
	@Override
	public List<HouseSource> selectInfoNopass() {
