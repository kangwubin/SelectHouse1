    ...
    <img src="/selsectHouse/afterView/img/topimg004.jpg">
        ...
        <div class="content bgwhite  sfyzDiv">
            ...
            <div class="yz pad_20">
                ...
                <table>
                    <tbody><tr>
                        <td class="size16 tr" width="164">管理员工号&nbsp;</td>
                        <td class="checkinput" colspan="2" width="300">
                            <input name="adminname" type="text" id="txtXm" class="bs lh_30 ti" datatype="/^[\u2e80-\ufe4f\ufa2d\a-zA-Z_\.·\s+]{2,20}$/" placeholder="请输入管理员工号" nullmsg="管理员用户名不能为空！" errormsg="请输入正确的管理员用户名！" sucmsg=" " maxlength="50"></td>
                        <td class="prel">
