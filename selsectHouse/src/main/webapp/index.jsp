			...
			<div>
				<div class="xmgsList">
					...
					<table class=" w_100">
						<tbody>
							<tr height="30">
								<td width="529" align="left"><span class="color_999999 vm" style="font-size: 22px;color: red;">销售公告</span></td>
							</tr>
							<tr height="30">
					...
					<table class=" w_100">
						<tr height="30">
							<td width="529" align="left"><span class="color_999999 vm" style="font-size: 22px;color: red;">摇号公告</span></td>
						</tr>
						<tr height="30">
							<td width="529" align="left"><span class="color_999999 vm">楼盘名称：</span><span
								title="陕西佳鑫置业有限公司"
							...
							<td width="529" align="left"><span class="color_999999 vm">摇号时间：</span><span
								class="vm max_w426 color_e34156"><%=hou.getLOTIERY_START_TIME()%></span></td>
						</tr>
					</table>
					<hr>
					<table class=" w_100">
						<tr height="30">
							<td width="529" align="left"><span class="color_999999 vm" style="font-size: 22px;color: red;">选房公告</span></td>
						</tr>
						...
						<tr height="30">
							...
							<td width="529" align="left"><span class="color_999999 vm">选房时间：</span><span
								class="vm max_w426 color_e34156"><%=hou.getSELECT_HOUSE_END_TIME()%></span></td>
						</tr>
					</table>
					<hr>
